...
def evalution_batch(total_predicted_value,total_true_value):
    ...
    example_based_F1_Measure = np.mean((true_and_predict * 2) / (np.sum(total_true_value, axis=1)
    ...
    return example_based_F1_Measure, Micro_F1, Macro_F1
...
def main(argv=None):
    global trainDataSet, STEPS_PER_ECOPH, MAX_STEPS, CKPT_PERIOD
    newTrain = True
    checkpoint = 0
