...
def loop_func():
    global THRESHOLD1, THRESHOLD2, THRESHOLD3, THRESHOLD4, SUM
    THRESHOLD1 = int(input('THRESHOLD1:'))
    THRESHOLD2 = int(input('THRESHOLD2:'))
    THRESHOLD4 = int(input('THRESHOLD4:'))
    threshold_list = input('THRESHOLD3:')
    threshold_list = threshold_list.split(' ')
    threshold_list = [int(i) for i in threshold_list]
    for threshold in threshold_list:
        THRESHOLD3 = threshold
        SUM = 0
        generate_hier_n_data_leaf2root()
        print('%d  %d  %d  %d : %d' % (THRESHOLD1, THRESHOLD2, THRESHOLD3, THRESHOLD4, SUM))
